...
<head>
    ...
    <script type="text/javascript" language="JavaScript" src="../lib/js/inputmask/jquery.inputmask.bundle.min.js"></script>
</head>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-12 m-auto table" id="table" style="margin-top: 10%;">
            <table class="table table-bordered table-hovered table-striped" id="productTable">
                ...
                foreach($products as $product) : ?>
                    ...
                    <tr>
                        <td> <?php echo $product['ind_actividad']; ?> </td>
                    ...
                    <div class="form">
                        <div class="row ">
                            ...
                            <div class="form-group">
                                <div class="col-md-6">
                                    <input type="hidden" id="pk_num_actividad" name="pk_num_actividad">
                                    <input id="fname" name="name" type="text" placeholder="Nombre de la Actividad" class="form-control">
                                </div>
...
<script>
    $(document).ready( function () {
        ...
        $('#guardar').click( function () {
            ...
            var hora= $('#hora').val();
            var id= $('#pk_num_actividad').val();
            if (id!=""){
                var caso = "editarActividad";
                var datos= {'Nombre':equipo, 'pk_num_actividad': id,'caso': caso};
            }else {
                var caso = "guardarActividad";
                var datos= {'Nombre':equipo,'hora':hora ,'caso': caso};
